...
* User can add friends and family members to a group
* User can view the newsletter for the time period with all of the data from their group
* User can view a list of their groups and the archive of past newsletters for each
